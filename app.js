...
const invoices = [
  { id: 'INV-20481', vendor: 'Atlas Industrial Supply', vendorInvoice: 'ASI-774383', amount: 12480, status: 'Ready to record', type: 'match', flowProposal: 'Directly to recording', accountPosting: '6410 · Equipment', accountingDate: 'Apr 2, 2026', currency: 'USD', po: '4500821', poTone: 'good', match: 100, matchTone: 'good', matchBasis: 'po', matchStatus: 'fully-matched', varianceLabel: 'No variance', varianceAmount: 0, approvalRequired: false, due: 'Apr 30, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, explanation: 'All purchase-order lines, quantities, unit prices, and delivered quantities match purchase order 4500821.', lines: [['Industrial gearbox — Model X200', 4, 2450], ['Mounting kit', 4, 320], ['Freight', 1, 1400]] },
  { id: 'INV-77821', vendor: 'Precision Tools Co.', vendorInvoice: 'PTC-55392', amount: 3265, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6420 · Tooling', accountingDate: 'Apr 6, 2026', currency: 'USD', po: '4500838', poTone: 'warn', match: 96, matchTone: 'warn', matchBasis: 'po', matchStatus: 'price-variance', varianceLabel: 'Price variance', varianceAmount: 130.6, due: 'May 4, 2026', owner: 'Jordan Lee', role: 'department-manager', confidence: 97, explanation: 'The supplier, item, and received quantity match purchase order 4500838, but the invoice unit price is 4% above the purchase-order price. Manager review is required.', lines: [['CNC tooling set', 1, 3265]] },
  { id: 'INV-78403', vendor: 'Midwest Safety Supply', vendorInvoice: 'MSS-40182', amount: 2180, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6440 · Safety supplies', accountingDate: 'Apr 7, 2026', currency: 'USD', po: '4500844', poTone: 'warn', match: 94, matchTone: 'warn', matchBasis: 'po', matchStatus: 'delivery-variance', varianceLabel: 'Delivery variance', varianceAmount: 280, due: 'May 6, 2026', owner: 'Jordan Lee', role: 'department-manager', confidence: 95, explanation: 'The invoiced quantity is greater than the delivered quantity on purchase order 4500844. Supplier, item, and unit price match; manager confirmation is required.', lines: [['Plant safety equipment', 2, 1090]] },
  { id: 'INV-80116', vendor: 'Pioneer Office Interiors', vendorInvoice: 'POI-28614', amount: 5940, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6120 · Office equipment', accountingDate: 'Apr 8, 2026', currency: 'USD', po: '4500847', poTone: 'warn', match: 92, matchTone: 'warn', matchBasis: 'po', matchStatus: 'price-variance', varianceLabel: 'Price variance', varianceAmount: 297, due: 'May 8, 2026', owner: 'Jordan Lee', role: 'department-manager', confidence: 93, explanation: 'The supplier, item, and received quantity match purchase order 4500847, but the invoice unit price is 5% above the purchase-order price. Manager review is required.', lines: [['Ergonomic workstations', 3, 1980]] },
  { id: 'INV-81742', vendor: 'Lakeview Electrical Services', vendorInvoice: 'LES-91726', amount: 4725, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6810 · Facility maintenance', accountingDate: 'Apr 10, 2026', currency: 'USD', po: '4500852', poTone: 'warn', match: 95, matchTone: 'warn', matchBasis: 'po', matchStatus: 'delivery-variance', varianceLabel: 'Delivery variance', varianceAmount: 525, due: 'May 10, 2026', owner: 'Jordan Lee', role: 'department-manager', confidence: 96, explanation: 'The invoice references purchase order 4500852 and the agreed service rate, but one completion receipt is missing. Rillion flagged the delivery variance for manager review.', lines: [['Panel inspection and repairs', 1, 4725]] },
  { id: 'INV-99314', vendor: 'Summit Packaging', vendorInvoice: 'SP-209875', amount: 8750, status: 'PO exception', type: 'exception', flowProposal: 'AP review', accountPosting: 'Review required', accountingDate: 'Apr 9, 2026', currency: 'USD', po: 'No PO', poTone: 'bad', match: 72, matchTone: 'bad', matchBasis: 'exception', matchStatus: 'po-missing', varianceLabel: 'Purchase order missing', varianceAmount: 8750, due: 'May 7, 2026', owner: 'AP review', role: 'ap-review', confidence: 84, explanation: 'No purchase order or contract reference was found. AP must confirm the supplier and coding before the invoice can enter approval.', lines: [['Protective packaging', 50, 175]] },
  { id: 'INV-82416', company: 30, vendor: 'Meridian Software Services', vendorInvoice: 'MSS-82416', amount: 8420, tax: 673.6, taxRate: 8, information: 'AI proposals ready for approval', status: 'AP review', type: 'approval', flowProposal: 'AI generated', accountPosting: 'AI generated · 6710', accountingDate: 'Apr 11, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 96, matchTone: 'good', matchBasis: 'non-po', matchStatus: 'ai-matched', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, due: 'May 11, 2026', owner: 'AP review', role: 'ap-review', confidence: 96, explanation: 'AI recognized a recurring software subscription, matched the vendor and service period to approved history, and proposed the AP review flow with account 6710.', lines: [['Annual planning software subscription', 1, 8420]] },
  { id: 'INV-82607', company: 30, vendor: 'Cedar Ridge Marketing', vendorInvoice: 'CRM-88914', amount: 4875, tax: 0, taxRate: 0, information: 'AI proposals need manager confirmation', status: 'Manager approval', type: 'approval', flowProposal: 'AI generated', accountPosting: 'AI generated · 6540', accountingDate: 'Apr 13, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 94, matchTone: 'warn', matchBasis: 'non-po', matchStatus: 'ai-review', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, due: 'May 13, 2026', owner: 'Jordan Lee', role: 'department-manager', confidence: 94, explanation: 'AI identified campaign services and proposed the prior marketing-services account 6540. Department manager confirmation is required because the campaign name is new.', lines: [['Spring campaign services', 1, 4875]] },
  { id: 'INV-82932', company: 30, vendor: 'GreenLine Waste Services', vendorInvoice: 'GLW-44052', amount: 2340, tax: 0, taxRate: 0, information: 'AI proposals ready for approval', status: 'AP review', type: 'approval', flowProposal: 'AI generated', accountPosting: 'AI generated · 6255', accountingDate: 'Apr 16, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 97, matchTone: 'good', matchBasis: 'non-po', matchStatus: 'ai-matched', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, due: 'May 16, 2026', owner: 'AP review', role: 'ap-review', confidence: 97, explanation: 'AI matched the recurring waste-service location and monthly billing pattern, then proposed the AP review flow and account 6255.', lines: [['Monthly waste services', 1, 2340]] },
  { id: 'INV-83148', company: 20, vendor: 'HarborPoint Insurance', vendorInvoice: 'HPI-260417', amount: 15600, tax: 0, taxRate: 0, information: 'AI proposals need controller confirmation', status: 'Finance review', type: 'approval', flowProposal: 'AI generated', accountPosting: 'AI generated · 6720', accountingDate: 'Apr 19, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 92, matchTone: 'warn', matchBasis: 'non-po', matchStatus: 'ai-review', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, due: 'May 19, 2026', owner: 'Morgan Patel', role: 'finance-controller', confidence: 92, explanation: 'AI matched the policy period and vendor to approved insurance invoices and proposed account 6720. Finance controller confirmation is required for the annual premium increase.', lines: [['Annual property insurance premium', 1, 15600]] },
  { id: 'INV-66102', vendor: 'Riverside Logistics', vendorInvoice: 'RL-88014', amount: 960, status: 'Finance review', type: 'approval', flowProposal: 'Finance controller', accountPosting: '6210 · Freight', accountingDate: 'Apr 12, 2026', currency: 'USD', po: '4500841', poTone: 'warn', match: 91, matchTone: 'warn', matchBasis: 'po', matchStatus: 'delivery-variance', varianceLabel: 'Delivery variance', varianceAmount: 120, due: 'May 12, 2026', owner: 'Morgan Patel', role: 'finance-controller', confidence: 94, explanation: 'Freight charges match purchase order 4500841, but one delivery receipt is incomplete. Finance review is required before posting.', lines: [['Regional freight', 1, 960]] },
  { id: 'INV-55277', vendor: 'Core Facility Services', vendorInvoice: 'CFS-44871', amount: 4320, status: 'Ready to record', type: 'match', flowProposal: 'Directly to recording', accountPosting: '6810 · Maintenance', accountingDate: 'Apr 15, 2026', currency: 'USD', po: '4500770', poTone: 'good', match: 100, matchTone: 'good', matchBasis: 'po', matchStatus: 'fully-matched', varianceLabel: 'No variance', varianceAmount: 0, approvalRequired: false, due: 'May 15, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, explanation: 'The maintenance line, quantity, price, and completed delivery match purchase order 4500770.', lines: [['Quarterly maintenance', 1, 4320]] },
  { id: 'INV-18044', company: 20, vendor: 'Brightwell Consulting', vendorInvoice: 'BC-94811', amount: 6480, tax: 0, taxRate: 0, information: 'AI proposals ready', status: 'AP review', type: 'match', flowProposal: 'AI generated', accountPosting: 'AI generated · 6530', accountingDate: 'Apr 17, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 99, matchTone: 'good', matchBasis: 'non-po', matchStatus: 'ai-matched', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, logOnly: true, due: 'May 17, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, explanation: 'AI recognized recurring advisory services from Brightwell Consulting and proposed the prior approved flow and account 6530 based on vendor history and invoice text.', lines: [['Advisory services', 1, 6480]] },
  { id: 'INV-18057', company: 20, vendor: 'Lumen Cloud Services', vendorInvoice: 'LCS-33081', amount: 12900, tax: 1032, taxRate: 8, information: 'AI proposals need review', status: 'AP review', type: 'match', flowProposal: 'AI generated', accountPosting: 'AI generated · 6710', accountingDate: 'Apr 18, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 97, matchTone: 'warn', matchBasis: 'non-po', matchStatus: 'ai-review', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, logOnly: true, due: 'May 18, 2026', owner: 'AP automation', role: 'ap-review', confidence: 98, explanation: 'AI matched the cloud subscription to prior Lumen invoices and proposed account 6710. The tax amount differs from the most recent pattern, so AP review remains required.', lines: [['Cloud platform subscription', 1, 12900]] },
  { id: 'INV-18063', company: 20, vendor: 'Harbor Office Services', vendorInvoice: 'HOS-77125', amount: 1840, tax: 147.2, taxRate: 8, information: 'AI proposals ready', status: 'AP review', type: 'match', flowProposal: 'AI generated', accountPosting: 'AI generated · 6110', accountingDate: 'Apr 20, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 95, matchTone: 'good', matchBasis: 'non-po', matchStatus: 'ai-matched', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, logOnly: true, due: 'May 20, 2026', owner: 'AP automation', role: 'ap-review', confidence: 96, explanation: 'AI identified the office-services description and repeated vendor pattern, then proposed the approved AP flow and account 6110.', lines: [['Office services', 1, 1840]] },
  { id: 'INV-18079', company: 30, vendor: 'Northstar Utilities', vendorInvoice: 'NU-405193', amount: 7215, tax: 0, taxRate: 0, information: 'AI proposals ready', status: 'AP review', type: 'match', flowProposal: 'AI generated', accountPosting: 'AI generated · 6250', accountingDate: 'Apr 22, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 98, matchTone: 'good', matchBasis: 'non-po', matchStatus: 'ai-matched', varianceLabel: 'Non-PO', varianceAmount: 0, aiMatched: true, logOnly: true, due: 'May 22, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, explanation: 'AI recognized a recurring electric-utility invoice, matched the service period and company, and proposed account 6250 from approved history.', lines: [['Electric utility service', 1, 7215]] },
  { id: 'INV-18085', company: 30, vendor: 'Window Wizards', vendorInvoice: 'WW-00795', amount: 25, tax: 0, taxRate: 0, information: 'Contract match complete', contract: 'CT-0076', status: 'Ready to record', type: 'match', flowProposal: 'Directly to recording', accountPosting: 'Contract coding', accountingDate: 'Jul 22, 2026', currency: 'USD', po: '—', poTone: 'none', match: 100, matchTone: 'good', matchBasis: 'contract', matchStatus: 'fully-matched', varianceLabel: 'No variance', varianceAmount: 0, approvalRequired: false, logOnly: true, due: 'Aug 21, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, explanation: 'The vendor, service date, amount, and coding match active contract CT-0076, so the invoice can go directly to recording.', lines: [['Window cleaning', 1, 25]] }
];
...
const analyticsReports = [
  ...
  { group: 'AP Reports', title: 'Active invoices', image: 'assets/analytics/active-invoices.png', leftRail: true, copy: 'See active invoice volume, flow status, invoice type, match status, role bottlenecks, and the underlying invoice list.' },
  ...
  { group: 'Performance Tracking Reports', title: 'Invoice flow tracking', image: 'assets/analytics/invoice-flow-tracking.png', leftRail: true, copy: 'Follow invoice-flow activity, role processing time, users, bottlenecks, and the detailed transfer history.' },
  { group: 'Performance Tracking Reports', title: 'Invoice summary', image: 'assets/analytics/invoice-summary.png', leftRail: true, copy: 'Review invoice volume, matching and capture types, flow and coding proposals, automation success, and vendor concentration.' },
  ...
  { group: 'Business Reports', title: 'Vendor payment analyzer', image: 'assets/analytics/vendor-payment-analyzer.png', leftRail: true, copy: 'Compare vendor payment timing, terms, late and early payments, and invoice volume across companies.' },
  { group: 'Executive Dashboard', title: 'Executive dashboard', image: 'assets/analytics/executive-dashboard.png', leftRail: true, copy: 'Track invoice volume, processing time, successful flows, coding automation, and matched spend over time.' },
  { group: 'Procurement Reports', title: 'Procurement overview', image: 'assets/analytics/procurement-overview.png', leftRail: true, copy: 'Review purchase-order, delivery, invoice-match, currency, and item performance in one procurement view.' },
  { group: 'Procurement Reports', title: 'Procurement trend', image: 'assets/analytics/procurement-trend.png', leftRail: true, copy: 'Explore adjusted purchasing amounts over time with matching, vendor, order, item, and company filters.' }
];
...
const matchClass = inv => inv.matchTone === 'good' ? 'match' : inv.matchTone === 'warn' ? 'approval' : 'exception';
const matchLabel = inv => inv.aiMatched ? `AI matched · ${inv.confidence}% confidence` : inv.matchStatus === 'delivery-variance' ? `Delivery variance · ${inv.confidence}% confidence` : inv.matchStatus === 'price-variance' ? `Price variance · ${inv.confidence}% confidence` : inv.matchStatus === 'fully-matched' ? `Fully matched · ${inv.confidence}% confidence` : `Match exception · ${inv.confidence}% confidence`;
...
function matchSummary(inv) {
  ...
  return `<details class="match-summary ${inv.matchTone}" open><summary><span>${inv.aiMatched ? 'AI matching explanation' : 'Purchase-order matching explanation'}</span><strong>${matchLabel(inv)}</strong></summary><p>${inv.explanation}</p><div>${variance}<span>${inv.matchBasis === 'non-po' ? 'AI flow and account proposals' : inv.po}</span></div></details>`;
}
...
function relay(inv) {
  ...
  const matchPanel = `<section class="panel"><div class="panel-head"><h3>${inv.aiMatched ? 'AI match evidence' : 'PO match evidence'}</h3><span class="status ${matchClass(inv)}">${inv.confidence}%</span></div><div class="evidence">${[['Matching type', inv.aiMatched ? 'AI matching' : inv.matchBasis === 'contract' ? 'Contract matching' : 'Purchase order matching'], ['Reference', inv.matchBasis === 'non-po' ? 'No purchase order' : inv.po], ['Result', inv.varianceLabel], ['Variance', money(inv.varianceAmount || 0)], ['Confidence', `${inv.confidence}%`]].map(([label, value]) => `<div class="evidence-row"><span>${label}</span><strong>${value}</strong></div>`).join('')}</div></section>`;
...
function invoiceLog() {
  ...
  const rows = matches.map(inv => {
    ...
    const poState = inv.po === 'Non-PO' ? 'Non-PO verified' : inv.matchStatus === 'delivery-variance' ? 'Delivery variance' : inv.matchStatus === 'price-variance' ? 'Price variance' : inv.poTone === 'good' ? 'PO matched' : 'PO missing';
    const purchaseOrder = inv.matchBasis === 'contract' ? '—' : `<strong>${inv.po}</strong>${health(inv.poTone, poState)}`;
    const contract = inv.contract ? `<strong>${inv.contract}</strong>${inv.matchBasis === 'contract' ? health('good', 'Contract matched') : ''}` : '—';
    return `<tr><td>${inv.company || 30}</td><td><button class="table-link invoice-log-link" data-invoice="${inv.id}" aria-label="Open ${inv.id} from ${inv.vendor}"><strong>${inv.vendor}</strong><small>${inv.id}</small></button></td><td>${inv.vendorInvoice}</td><td>${proposal}</td><td>${posting}</td><td>${logDate(inv.accountingDate)}</td><td><span class="date-chip">${logDate(inv.due)}</span></td><td class="numeric">${number(inv.amount)}</td><td class="numeric">${number(inv.tax || 0)}</td><td class="numeric">${number(inv.taxRate || 0)}</td><td>${inv.currency}</td><td>${inv.information || (inv.type === 'exception' ? 'Review required' : 'Matching complete')}</td><td>${purchaseOrder}</td><td>${contract}</td><td>${health(inv.matchTone, matchLabel(inv))}</td><td>${status(inv)}</td></tr>`;
  }).join('');
...
const tourSets = {
  platform: [
    ...
    { title: 'Explore Analytics', copy: 'Explore eleven source-faithful boards in the same order as Rillion Analytics.', view: 'analytics', analytics: 1 }
  ],
  ap: [
  ...
  finance: [
    ...
    { title: 'Explore executive Analytics', copy: 'Review the source-faithful Executive dashboard and continue through the Rillion Analytics board sequence.', view: 'analytics', analytics: 8 },
