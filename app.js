...
const invoices = [
  { id: 'INV-20481', vendor: 'Atlas Industrial Supply', vendorInvoice: 'ASI-774383', amount: 12480, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6410 · Equipment', accountingDate: 'Apr 2, 2026', currency: 'USD', po: '4500821', poTone: 'good', match: 98, matchTone: 'good', due: 'Apr 30, 2026', owner: 'Alex Nguyen', role: 'department-manager', confidence: 99, lines: [['Industrial gearbox — Model X200', 4, 2450], ['Mounting kit', 4, 320], ['Freight', 1, 1400]] },
  { id: 'INV-77821', vendor: 'Precision Tools Co.', vendorInvoice: 'PTC-55392', amount: 3265, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6420 · Tooling', accountingDate: 'Apr 6, 2026', currency: 'USD', po: '4500838', poTone: 'warn', match: 96, matchTone: 'warn', due: 'May 4, 2026', owner: 'Jordan Lee', role: 'department-manager', confidence: 97, lines: [['CNC tooling set', 1, 3265]] },
  { id: 'INV-99314', vendor: 'Summit Packaging', vendorInvoice: 'SP-209875', amount: 8750, status: 'PO exception', type: 'exception', flowProposal: 'AP review', accountPosting: 'Review required', accountingDate: 'Apr 9, 2026', currency: 'USD', po: 'No PO', poTone: 'bad', match: 72, matchTone: 'bad', due: 'May 7, 2026', owner: 'AP review', role: 'ap-review', confidence: 84, lines: [['Protective packaging', 50, 175]] },
  { id: 'INV-66102', vendor: 'Riverside Logistics', vendorInvoice: 'RL-88014', amount: 960, status: 'AP review', type: 'match', flowProposal: 'Finance controller', accountPosting: '6210 · Freight', accountingDate: 'Apr 12, 2026', currency: 'USD', po: '4500841', poTone: 'warn', match: 91, matchTone: 'warn', due: 'May 12, 2026', owner: 'Morgan Patel', role: 'finance-controller', confidence: 94, lines: [['Regional freight', 1, 960]] },
  { id: 'INV-55277', vendor: 'Core Facility Services', vendorInvoice: 'CFS-44871', amount: 4320, status: 'Manager approval', type: 'approval', flowProposal: 'Department manager', accountPosting: '6810 · Maintenance', accountingDate: 'Apr 15, 2026', currency: 'USD', po: '4500770', poTone: 'good', match: 100, matchTone: 'good', due: 'May 15, 2026', owner: 'Alex Nguyen', role: 'department-manager', confidence: 99, lines: [['Quarterly maintenance', 1, 4320]] },
  { id: 'INV-18044', company: 20, vendor: 'Brightwell Consulting', vendorInvoice: 'BC-94811', amount: 6480, tax: 0, taxRate: 0, information: 'Matching complete', contract: 'CT-2216', status: 'Ready to record', type: 'match', flowProposal: 'Directly to recording', accountPosting: 'AI generated · 6530', accountingDate: 'Apr 17, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 99, matchTone: 'good', aiMatched: true, logOnly: true, due: 'May 17, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, lines: [['Advisory services', 1, 6480]] },
  { id: 'INV-18057', company: 20, vendor: 'Lumen Cloud Services', vendorInvoice: 'LCS-33081', amount: 12900, tax: 1032, taxRate: 8, information: 'AI coding review', contract: 'CT-2198', status: 'AP review', type: 'match', flowProposal: 'Accounts payable +1', accountPosting: 'AI generated · 6710', accountingDate: 'Apr 18, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 97, matchTone: 'warn', aiMatched: true, logOnly: true, due: 'May 18, 2026', owner: 'AP automation', role: 'ap-review', confidence: 98, lines: [['Cloud platform subscription', 1, 12900]] },
  { id: 'INV-18063', company: 20, vendor: 'Harbor Office Services', vendorInvoice: 'HOS-77125', amount: 1840, tax: 147.2, taxRate: 8, information: 'Matching complete', contract: 'CT-1882', status: 'Ready to record', type: 'match', flowProposal: 'Directly to recording', accountPosting: 'AI generated · 6110', accountingDate: 'Apr 20, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 95, matchTone: 'good', aiMatched: true, logOnly: true, due: 'May 20, 2026', owner: 'AP automation', role: 'ap-review', confidence: 96, lines: [['Office services', 1, 1840]] },
  { id: 'INV-18079', company: 30, vendor: 'Northstar Utilities', vendorInvoice: 'NU-405193', amount: 7215, tax: 0, taxRate: 0, information: 'Matching complete', contract: 'CT-2035', status: 'AP review', type: 'match', flowProposal: 'Accounts payable +1', accountPosting: 'AI generated · 6250', accountingDate: 'Apr 22, 2026', currency: 'USD', po: 'Non-PO', poTone: 'good', match: 98, matchTone: 'good', aiMatched: true, logOnly: true, due: 'May 22, 2026', owner: 'AP automation', role: 'ap-review', confidence: 99, lines: [['Electric utility service', 1, 7215]] }
];
...
function queue() {
  const matches = filtered().filter(inv => !inv.logOnly);
...
function invoiceLog() {
  ...
  const rows = matches.map(inv => {
    const proposal = inv.aiMatched ? account('good', inv.flowProposal) : inv.type === 'exception' ? account('bad', inv.flowProposal) : inv.flowProposal;
    ...
    return `<tr data-invoice="${inv.id}" tabindex="0" role="link" aria-label="Open ${inv.id} from ${inv.vendor}"><td>${inv.company || 30}</td><td><strong>${inv.vendor}</strong><small>${inv.id}</small></td><td>${inv.vendorInvoice}</td><td>${proposal}</td><td>${posting}</td><td>${logDate(inv.accountingDate)}</td><td><span class="date-chip">${logDate(inv.due)}</span></td><td class="numeric">${number(inv.amount)}</td><td class="numeric">${number(inv.tax || 0)}</td><td class="numeric">${number(inv.taxRate || 0)}</td><td>${inv.currency}</td><td>${inv.information || (inv.type === 'exception' ? 'Review required' : 'Matching complete')}</td><td><strong>${inv.po}</strong>${health(inv.poTone, inv.po === 'Non-PO' ? 'Non-PO verified' : inv.poTone === 'good' ? 'PO matched' : inv.poTone === 'warn' ? 'PO variance' : 'PO missing')}</td><td>${inv.contract || '—'}</td><td>${health(inv.matchTone, inv.aiMatched ? `AI matched ${inv.match}%` : inv.matchTone === 'good' ? `Matched ${inv.match}%` : inv.matchTone === 'warn' ? `Review ${inv.match}%` : `Exception ${inv.match}%`)}</td><td>${status(inv)}</td></tr>`;
  }).join('');
...
function approvalReport() {
  ...
  const approvalInvoices = invoices.filter(inv => !inv.logOnly);
